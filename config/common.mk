...
export POWERKEY_ANC ?= 0
ifeq ($(POWERKEY_ANC),1)
KBUILD_CPPFLAGS += -D__POWERKEY_CTRL_BT_ANC__
...
CUSTOM_BIN_CONFIG_SIZE ?= 0x02

export LDS_SECTION_FLAGS := \
	-DCUSTOM_BIN_CONFIG_SIZE=$(CUSTOM_BIN_CONFIG_SIZE) \
...
export SPEECH_TX_2MIC_NS9 ?= 0
ifeq ($(SPEECH_TX_2MIC_NS9),1)
KBUILD_CPPFLAGS += -DSPEECH_TX_2MIC_NS9
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC
KBUILD_CPPFLAGS += -DCOH_FRAME_LENGTH=$(COH_FRAME_LENGTH)
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2
endif
...
ifeq ($(BT_DRV_EXTRA_CFG_DISABLE),1)
KBUILD_CPPFLAGS += -D__BT_DRV_EXTRA_CFG_DISABLE__
endif